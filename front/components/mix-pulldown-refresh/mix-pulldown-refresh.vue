	...
	<!-- #endif -->
		...
		<view class="mix-loading-wrapper">
			...
			<image
				class="mix-loading-icon" 
				:class="{active: refreshing, ready: refreshReady}" 
				src="data:image/png;base64,"
				/>			
			</image>
			<text class="mix-load-text">{{text}}</text>
		</view>
		<slot></slot>
