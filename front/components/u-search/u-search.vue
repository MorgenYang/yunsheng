	...
	<view class="u-search" @tap="clickHandler" :style="{
		...
		>
			<view class="u-icon-wrap">
				<image style="width: 30upx;height: 30upx;" src="../../static/icon/img/search-icon.png"></image>
			</view>
			<input
				confirm-type="search"
				@blur="blur"
			...
			<view class="u-close-wrap" v-if="keyword && clearabled && focused" @tap="clear">
				<image style="width: 20upx;height: 20upx;" src="../../static/icon/img/clear-icon.png"></image>
			</view>
		</view>
